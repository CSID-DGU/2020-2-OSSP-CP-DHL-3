...
l4_frame = tk.Frame(frame, width = x * 0.2, height = y * 0.166, bg='blue')
...
r4_frame = tk.Frame(frame, width = x * 0.2, height = y * 0.166, bg='blue')
r4_frame.grid(row = 4, column = 4)

r5_frame = tk.Frame(frame, width = x * 0.2, height = y * 0.166, bg='red')
r5_frame.grid(row = 5, column = 4)

option_frame = tk.Frame(frame, width = x * 0.6, height = y * 0.166, bg='navy')
